...
import { machineRequestAPI } from '../../api/machineRequestAPI';
import { useToast } from '../../contexts/ToastContext';

export default function RequestMachineModal({ isOpen, onClose, machine }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await machineRequestAPI.create({
        ...formData,
      ...
      <Modal isOpen={isOpen} onClose={handleClose} title="Request Submitted">
        <div className="text-center py-8">
          ...
          <p className="text-gray-700 mb-4">
            Your request for <strong>{machine.name}</strong> has been submitted successfully.
          </p>
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Request Machine Information">
      <div className="space-y-6">
        <div className="flex items-start gap-4 bg-blue-50 rounded-xl p-4 border border-blue-100">
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-2">Machine Details</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="Any specific requirements, questions about the machine, or need for demo/trial..."
            />
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-blue-600 text-white font-semibold text-lg py-3 rounded-lg hover:bg-blue-700 transition disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
        ...
        <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            ...
            <li className="flex items-start gap-2">
              <span className="text-blue-600 mt-0.5">✓</span>
              <span>We'll provide detailed information about the machine, pricing, and availability</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 mt-0.5">✓</span>
              <span>We can arrange a demo or trial if needed</span>
            </li>
          </ul>
        </div>
      </div>
